...
protected:
	...
	颜色* i通道颜色;
	Ome属性读入器(UINT8 SizeC, UINT8 SizeZ, UINT16 SizeT, 维度顺序 DimensionOrder, 颜色* 通道颜色) :iSizeC(SizeC), iSizeZ(SizeZ), iSizeT(SizeT), iDimensionOrder(DimensionOrder), i通道颜色(通道颜色) {}
public:
	...
	const 颜色* 通道颜色()const override { return i通道颜色; }
	virtual ~Ome属性读入器() { free(i通道颜色); }
};