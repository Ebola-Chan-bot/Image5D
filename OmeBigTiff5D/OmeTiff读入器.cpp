...
OmeTiff读入器::OmeTiff读入器(文件指针& 文件, 像素类型 iPixelType, UINT16 iSizeX, UINT16 iSizeY, UINT32 iSizeI, 文本数组& 图像描述, IFD数组& IFD像素指针, UINT8 SizeC, UINT8 SizeZ, UINT16 SizeT, 维度顺序 DimensionOrder, 颜色数组& 通道颜色) :
	Tiff读入器(文件, iPixelType, iSizeX, iSizeY, iSizeI, 图像描述, IFD像素指针),
...
const OmeTiff读入器* OmeTiff读入器::只读打开(文件指针& 文件, 像素类型 iPixelType, UINT16 iSizeX, UINT16 iSizeY, UINT32 iSizeI, 文本数组& 图像描述, IFD数组& IFD像素指针)
{
	...
	return new OmeTiff读入器(文件, iPixelType, iSizeX, iSizeY, iSizeI, 图像描述, IFD像素指针, iSizeC, iSizeZ, iSizeT, iDimensionOrder, iChannelColors);
}